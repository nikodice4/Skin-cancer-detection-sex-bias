...
file_data = 'data/new_padufes/metadata.csv'
image_folder = 'data/new_padufes/imgs_part_1/'
mask_folder = 'data/new_padufes/new_padufes_masks/'
file_features = 'data/feature_group9_new.csv'
